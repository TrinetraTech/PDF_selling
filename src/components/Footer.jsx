      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">Premium study notes and resources for students worldwide.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition">Browse Notes</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Sell Notes</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition">Computer Science</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Medicine</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition">Law</a></li>
            </ul>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-2 max-w-md">
            <input type="email" placeholder="Your email address" className="px-4 py-2 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-600 flex-grow" />
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition font-medium">Subscribe</button>
          </div>
        </div>
